  ...
  return (
    <div className="space-y-6 bg-white p-8 rounded-3xl border border-slate-200/90 shadow-xl shadow-slate-200/50">
      <div className="space-y-2">
        <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Create MediSense Account</h2>
        <p className="text-sm text-slate-500 font-medium">Join the medical AI platform for diagnostic report intelligence.</p>
      </div>
